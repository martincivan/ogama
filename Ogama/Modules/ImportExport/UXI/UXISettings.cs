    ...
    public class UXISettings
    {
        ...
        private bool Serialize(string filePath)
        {
            try
            {
                ...
                {
                    XmlSerializer serializer = new XmlSerializer(typeof(UXISettings));
        ...
        private UXISettings Deserialize(string filePath)
        {
            try
            {
                UXISettings settings = new UXISettings();
                ...
                using (FileStream fs = new FileStream(filePath, FileMode.Open))
                {
                    ...
                    settings = (UXISettings)serializer.Deserialize(fs);
                }
